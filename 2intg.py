...
def create_dashboard(angle_dict, arduino_angles, anomaly_dict, arduino_anomaly, fps, frame_width):
    ...
    arduino_labels = ["Thumb", "Index", "Middle", "Ring"]
...
def main():
    arduino = ArduinoReader(port='COM3', baudrate=9600)  # Change COM port as needed
    ...
    while True:
        ...
        # Only flag anomaly if both systems agree (for first 4 fingers)
        double_anomaly = {}
        for idx, finger in enumerate(fingers):
            if finger == "Pinky":
